...
public class EmpleadosEmpresa {
    ...
    private static void eliminarEmpleadoDB(String nombre, String apellido) {
        Connection con = null;
        PreparedStatement ps = null;
        try {
            con = conectar();
    ...
    private static void actualizarEmpleado() {
        ...
        actualizarEmpleadoDB(nombre, apellido, nuevoPuesto, nuevoSalario);
    }
    // Método para actualizar un empleado en la base de datos
    private static void actualizarEmpleadoDB(String nombre, String apellido, String nuevoPuesto, double nuevoSalario) {
        Connection con = null;
        PreparedStatement ps = null;
        try {
            con = conectar();
