 ...
 * @author Ruper
 */
public class IG_EmpleadosEmpresa1 extends javax.swing.JFrame {
    private EmpleadosEmpresa1 empresa;
    /**
     * Creates new form IG_EmpleadosEmpresa
     */
    public IG_EmpleadosEmpresa1() {
        empresa = new EmpleadosEmpresa1();
    ...
    private void bt_AñadirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bt_AñadirActionPerformed
        try {
            ...
            String resultado = empresa.guardarEmpleadoDB(nuevoEmpleado);
    ...
    private void bt_EliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bt_EliminarActionPerformed
        try {
            ...
            if (codigo != null && !codigo.trim().isEmpty()) {
                String resultado = empresa.eliminarEmpleado(codigo);
                ta_Display.setText(resultado);
    ...
    private void bt_ActualizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bt_ActualizarActionPerformed
        try {
            ...
            if (codigo != null && !codigo.trim().isEmpty()) {
                ...
                if (nuevoPuesto != null && !nuevoPuesto.trim().isEmpty() && nuevoSalarioStr != null && !nuevoSalarioStr.trim().isEmpty()) {
                    double nuevoSalario = Double.parseDouble(nuevoSalarioStr);
                    String resultado = empresa.actualizarEmpleadoDB(codigo, nuevoPuesto, nuevoSalario);
                    ta_Display.setText(resultado);
    ...
    private void bt_BuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bt_BuscarActionPerformed
        try {
            ...
            if (codigo != null && !codigo.trim().isEmpty()) {
                String resultado = empresa.buscarEmpleado(codigo);
                ta_Display.setText(resultado);
            } else {
                JOptionPane.showMessageDialog(this, "Código del empleado no puede estar vacío.", "Error", JOptionPane.ERROR_MESSAGE);
            }
    ...
    private void bt_OrdenadosActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bt_OrdenadosActionPerformed
        try {
            // Obtener el resultado de la búsqueda de empleados ordenados por antigüedad
            String resultado = empresa.ordenadosPorAntigüedad();
            ta_Display.setText(resultado);
        } catch (Exception e) {
    ...
    private void bt_GastoTotalActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bt_GastoTotalActionPerformed
        try {
            ...
            ta_Display.setText("El gasto total en salarios es: " + gastoTotal);
        } catch (Exception e) {
    ...
    private void bt_MostrarAntiguosActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bt_MostrarAntiguosActionPerformed
        try {
            // Obtener el resultado de la búsqueda de empleados antiguos
            String resultado = empresa.mostrarEmpleadosAntiguos();
            ta_Display.setText(resultado);
        } catch (Exception e) {
    ...
    private void mostrarDatos() {
        ...
        for (Empleado empleado : EmpleadosEmpresa1.empleados) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(IG_EmpleadosEmpresa1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new IG_EmpleadosEmpresa1().setVisible(true);
            }
        });
    }
